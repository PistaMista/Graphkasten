...
LDFLAGS=-lgtkmm-3.0 -latkmm-1.6 -lgdkmm-3.0 -lgiomm-2.4 -lgtk-3 -lgdk-3 -lz -latk-1.0 -lcairo-gobject -lgio-2.0 -lpangomm-1.4 -lglibmm-2.4 -lcairomm-1.0 -lsigc-2.0 -lpangocairo-1.0 -lpango-1.0 -lharfbuzz -lcairo -lgdk_pixbuf-2.0 -lgobject-2.0 -lglib-2.0 

main.o: main.cpp helloworld.cpp
	g++ $(CXXFLAGS) $? $(LDFLAGS) -o $@

install:
	install main.o /usr/bin/zettelkasten-gtk

clean:
	rm main main.o helloworld.o
